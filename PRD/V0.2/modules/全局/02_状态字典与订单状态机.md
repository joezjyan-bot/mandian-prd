...
10. C 端不展示合作模式、资金来源、资方名称;合同模板和按钮话术由后台 `funding_source / terminology_template_id` 决定。
...
| 商家操作 | 审核商家订单、发货、上传材料、归还验收 | 接单、核销、还车验收、押金扣款 |
| 运营操作 | 审核、分配资方、**分配履约门店**(平台订单)、发起合同、退款、关闭 | 代接单、代核销、押金大额审批、逾期费用减免 |
